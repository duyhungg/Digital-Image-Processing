...
heading1 = Label(top, text="Môn Học Xử lý ảnh số",pady=10, font=('arial',20,'bold'))
...
heading3 = Label(top, text="Đỗ Ngọc Duy Hưng MSSV:20145267",pady=5, font=('arial',20,'bold'))
heading3.configure(background='#ffffff',foreground='#364156')

heading4 = Label(top, text="Nguyễn Phát Đạt MSSV:20110075",pady=5, font=('arial',20,'bold'))
heading4.configure(background='#ffffff',foreground='#364156')

heading5 = Label(top, text="Hồ Xuân Hiếu MSSV:20119339",pady=5, font=('arial',20,'bold'))
heading5.configure(background='#ffffff',foreground='#364156')
heading.pack()
heading1.pack()
heading2.pack()
heading3.pack()
